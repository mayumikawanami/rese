...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'photo_url' => 'https://rese-aws-bucket.s3.ap-northeast-1.amazonaws.com/image/sushi.jpg'
        ];
        ...
        $param = [
            ...
            'photo_url' => 'https://rese-aws-bucket.s3.ap-northeast-1.amazonaws.com/image/yakiniku.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo_url' => 'https://rese-aws-bucket.s3.ap-northeast-1.amazonaws.com/image/izakaya.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo_url' => 'https://rese-aws-bucket.s3.ap-northeast-1.amazonaws.com/image/italian.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'photo_url' => 'https://rese-aws-bucket.s3.ap-northeast-1.amazonaws.com/image/ramen.jpg'
        ];
        DB::table('shops')->insert($param);
